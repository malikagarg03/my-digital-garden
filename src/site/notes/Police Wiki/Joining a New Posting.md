---
{"dg-publish":true,"permalink":"/police-wiki/joining-a-new-posting/"}
---

# Joining a New Place of Posting

> [!tip] Set the tone from Day 0
...
- [ ] Organisation structure of the district/subdivision — units, stations, outposts
- [ ] Sanctioned strength vs actual strength (officers and men)
- [ ] Profiles of key officers — DSPs/SDPOs, CIs, SIs — postings history, reputation, any pending action

### Geography & Ground Reality
- [ ] Geography — terrain, forests, rivers, sensitive border areas
- [ ] Demographics — caste, community, religious composition
- [ ] Means of transport — road, rail, river; connectivity of remote areas
- [ ] Areas with poor communication or network coverage

### Crime Picture
- [ ] Crime statistics for the past 3 years
...
- [ ] List of important/sensational crimes from the past one year — investigation and trial status
- [ ] Known criminal gangs, history-sheeters, rowdy-sheeters — current status
- [ ] Pending warrants, proclaimed offenders, absconders

### Law & Order
- [ ] Planned events — major festivals, elections, VIP visits with historical sensitivities
- [ ] Unplanned incidents from past year — riots, clashes, bandhs, agitations
- [ ] Recurring communal, caste-based, or political flashpoints

### Important Persons
- [ ] Profiles of important persons — politicians (MPs, MLAs, local body), pressure groups, religious leaders, influential media persons
- [ ] Persons known to approach or influence police — know who they are before they approach you

### Personnel Matters
- [ ] Pending departmental enquiries and disciplinary cases
- [ ] Long-pending transfers, vacancies, promotions
- [ ] Grievances and welfare issues
...
- [ ] Sub-Collector / JC
- [ ] CJM / JFCM
- [ ] Other sub-division level officials as relevant
...
*See also: [[Format of crime statistics to be collected\|Format of crime statistics to be collected]] | [[How to review crime statistics\|How to review crime statistics]] | [[First Inspection Checklist\|First Inspection Checklist]] | [[Call-on Protocol\|Call-on Protocol]]*